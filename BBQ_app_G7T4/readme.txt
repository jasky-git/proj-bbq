Pls put bbq_app folder inside /www folder of wamp.
...
scripts.js ->change these 3 service URL to "http://xxxxxx:8080/inventory" 
					"http://xxx:8081/payment"
					"http://xxxxxxx:8087/orderdetails"
...
When using the UI,
At order_details.html, when entering card for payment, pls enter "4242 4242 4242 4242" for card number, 02/22 for expiry, 222 for csv, as it is in test mode
