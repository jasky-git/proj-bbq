...
class Order {
  ...
  public function __construct1($orderid='', $cname='', $phone='', $email='', $startpoint='', $endpoint='', $delivery_date='', $delivery_time='') {
  ...
  public function __construct2($orderid='', $itemid1='', $qty1='', $itemid2='', $qty2='', $itemid3='', $qty3='', $itemid4='', $qty4='', $itemid5='', $qty5='', $remarks='', $created_on='') {
      $this->orderid = $orderid;
